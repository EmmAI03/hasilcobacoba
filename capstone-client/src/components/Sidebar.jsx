            ...
            <div className="flex flex-col h-full">
                ...
                <nav className="flex-1 px-4 space-y-1">
                    {navLinks.map(link => {
                        ...
                        return (
                            <Link key={link.name} to={link.path} className={`sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 hover:bg-slate-100 transition-colors ${isActive ? 'active' : ''}`}>
