...
const initialProjectsData = {
    ToDo: [
        { id: 3, title: 'Q3 Marketing Campaign', description: 'Plan and execute the marketing campaign for Q3.', progress: 10, startDate: '2025-08-10', endDate: '2025-08-20', team: ['https://placehold.co/40x40/fecaca/991b1b?text=BD', 'https://placehold.co/40x40/fed7aa/9a3412?text=EK'] },
        { id: 5, title: 'Initial Research for AI Tool', description: 'Feasibility study for a new AI feature.', progress: 0, startDate: '2025-08-05', endDate: '2025-08-15', team: ['https://placehold.co/40x40/a7f3d0/14532d?text=AS'] },
    ],
    Ongoing: [
        { id: 1, title: 'Website Redesign', description: 'Complete overhaul of the main company website.', progress: 75, startDate: '2025-08-03', endDate: '2025-09-15', team: ['https://placehold.co/40x40/a7f3d0/14532d?text=AS', 'https://placehold.co/40x40/fecaca/991b1b?text=BD', 'https://placehold.co/40x40/bae6fd/0c4a6e?text=CJ'] },
    ],
    Done: [
        { id: 2, title: 'Mobile App Launch', description: 'Develop and launch the new iOS and Android app.', progress: 100, startDate: '2025-06-10', endDate: '2025-07-25', team: ['https://placehold.co/40x40/a7f3d0/14532d?text=AS', 'https://placehold.co/40x40/c7d2fe/3730a3?text=DM'] },
    ],
    Stuck: [
        { id: 4, title: 'API Integration', description: 'Integrate third-party payment API.', progress: 90, startDate: '2025-07-20', endDate: '2025-08-01', team: ['https://placehold.co/40x40/bae6fd/0c4a6e?text=CJ', 'https://placehold.co/40x40/c7d2fe/3730a3?text=DM', 'https://placehold.co/40x40/fed7aa/9a3412?text=EK'] },
    ]
};
